									...
									case 1:
									{
										...
										for (int i = 0; i < mat.size; i++) {
											for (int j = 0; j < mat.size; j++) {
												...
												switch (j) {
												case 0:
													cout << "изменение штата производства ";
													break;
												case 1:
													cout << "выпуск новой линейки продукции ";
													break;
												case 2:
													cout << "обновление оборудования ";
													break;
												}
												cout << "С" << i + 1 << j + 1 << " = ";
												mat.C[i][j] = Check<int>();
								...
								while (u == 0) {
									...
									case 2:
									{
										...
										while (true) {
											...
											mat.show();
											cout << endl << "1. Изменить матрицу взаимных оценок компетентности экспертов. " << endl;
											cout << endl << "2. Изменить матрицу оценок конкурирующих вариантов системы. " << endl;
											cout << endl << "0. Выход. " << endl;
											int choice = Check<int>();
											while (choice < 0 || choice > 2) {
												cout << "Ошибка ввода. Повторите попытку\n";
